package com.example.qrated.Adapters;
...
import com.example.qrated.CommentActivity;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsHolder> {
    ...
    public void onBindViewHolder(@NonNull NewsHolder holder, int position) {
        ...
        String numUp = current.getUpVoteCt();
        String numDown = current.getDownVoteCt();
        String numComment = current.getCommentCt();

        if(Integer.parseInt(numUp) >= 1000){
            String newNumUp = ((Integer.parseInt(numUp)))/1000 + "k";
            holder.upvoteCt.setText(newNumUp);
        }
        else{
            holder.upvoteCt.setText(current.getUpVoteCt());
        }
        if(Integer.parseInt(numDown) >= 1000){
            String newNumDown = ((Integer.parseInt(numDown)))/1000 + "k";
            holder.downVoteCt.setText(newNumDown);
        ...
        if(Integer.parseInt(numComment) >= 1000){
            String newNumComment = ((Integer.parseInt(numComment)))/1000 + "k";
            holder.commentCt.setText(newNumComment);
