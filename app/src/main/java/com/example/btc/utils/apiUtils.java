package com.example.btc.utils;

import androidx.annotation.NonNull;

import com.example.btc.Frames.ModelNews;
import com.example.btc.Frames.TrendingNews;
import com.example.btc.Interfaces.apiInterface;
...
public class apiUtils {
    ...
    public static String getApiKey(){
        ...
        return apiKeys[com.example.btc.utils.baseUtils.getRandomNumber(0, apiKeys.length)];
